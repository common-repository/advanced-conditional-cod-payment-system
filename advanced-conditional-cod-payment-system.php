...
define( 'ACCODPS_CD_PLUGIN_PATH', plugin_dir_path( __FILE__ ) );
// Default Values
...
$accodps_adv_pay_per = get_option('accodps_wc_advance_payment_percentage', $accodps_default_percentage);
$accodps_adv_min_order_total = get_option('accodps_wc_advance_payment_min_order_total', $accodps_default_min_amount);
$accodps_ap_title = get_option('accodps_advance_payment_title', $accodps_default_payment_title);
$accodps_ap_description = get_option('accodps_advance_payment_description', $accodps_default_payment_desc);
$accodps_ap_checkbox_text = get_option('accodps_advance_payment_checkbox_text', $accodps_default_payment_checkbox_text);
...
function accodps_wc_advance_payment_enqueue_scripts() {
    ...
    if (is_checkout()) {
        ...
        wp_localize_script('wc-advance-cod-payment-ajax', 'wc_advance_payment_params', array(
            ...
            'advance_payment_percentage' => $accodps_adv_pay_per,
            'min_order_total' => $accodps_adv_min_order_total,
...
require_once( ACCODPS_CD_PLUGIN_PATH . 'includes/frontend/frontend.php');
require_once( ACCODPS_CD_PLUGIN_PATH . 'includes/admin/admin.php');